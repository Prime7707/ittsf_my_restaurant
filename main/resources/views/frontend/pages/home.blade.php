...
<section class="relative w-full h-[70vh] overflow-hidden mb-10 tracking-wider">
	...
	<div id="slider" class="w-full h-full relative">
		<!-- Slide Items -->
		<div class="absolute inset-0 bg-cover bg-center transition-opacity duration-1000 opacity-100" style="background-image: url({{asset('assets/frontend/images/dishes/chicken_karahi.jpg')}});" data-index="0"></div>
		<div class="absolute inset-0 bg-cover bg-center transition-opacity duration-1000 opacity-0" style="background-image: url({{asset('assets/frontend/images/dishes/chicken_plao.jpg')}});" data-index="1"></div>
		<div class="absolute inset-0 bg-cover bg-center transition-opacity duration-1000 opacity-0" style="background-image: url({{asset('assets/frontend/images/dishes/Chicken_egg_fried_rice.jpg')}});" data-index="2"></div>
		<div class="absolute inset-0 bg-cover bg-center transition-opacity duration-1000 opacity-0" style="background-image: url({{asset('assets/frontend/images/dishes/pizza.jpeg')}});" data-index="3"></div>
		...
		<div class="absolute inset-0 bg-black/50 flex items-center px-8 md:px-24">
			<div class="text-white max-w-xl space-y-6">
				...
				<a href="#menu" class="inline-block btnStyle px-6 py-3 rounded-full text-[17px]">
					Order Now
				</a>
			</div>
		</div>
		...
		<!-- Dots -->
		<div class="absolute bottom-6 left-1/2 transform -translate-x-1/2 flex items-center space-x-2 z-5">
...
<!-- Best Seller Start-->
<section class="relative bg-frontend-dark-9 text-frontend-dark-2 px-10 py-10 mb-10 overflow-hidden">
	<h2 class="text-3xl font-bold text-center text-frontend-highlight-4 mb-8">Best Sellers</h2>

	<!-- Scroll Buttons -->
	<!-- Left Scroll Button -->
	<button id="prevSlide" class="absolute left-4 top-[57%] -translate-y-1/2 z-10 btnStyle p-4 rounded-full shadow-lg">
		<x-icon_lucid name="chevron-left" class="w-7 h-7" stroke-width="3" />
	</button>
	<!-- Right Scroll Button -->
	<button id="nextSlide" class="absolute right-4 top-[57%] -translate-y-1/2 z-10 btnStyle p-4 rounded-full shadow-lg">
		<x-icon_lucid name="chevron-right" class="w-7 h-7" stroke-width="3" />
	</button>
		...
		<div id="carousel" class="flex gap-6 overflow-x-auto scroll-smooth scrollbar-hide px-2 [scrollbar-width:none] [-ms-overflow-style:none]">
			...
			<div class="max-w-[300px] lg:max-w-[400px] bg-frontend-dark-8 rounded-xl p-4 flex-shrink-0 group relative overflow-hidden">
				...
				<div class="relative w-full h-[300px] rounded-md overflow-hidden">
					<img src="{{asset('assets/frontend/images/dishes/Chicken_egg_fried_rice.jpg')}}" alt="Dish 1" class="w-full h-full object-cover rounded-md">
					<!-- Overlay on Hover -->
					<div class="absolute inset-0 bg-black/60 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300">
						<a href="#menu" class="btnStyle px-4 py-2 rounded-full">
							Order Now
						</a>
					</div>
				</div>
			...
			<div class="max-w-[300px] lg:max-w-[400px] bg-frontend-dark-8 rounded-xl p-4 flex-shrink-0 group relative overflow-hidden">
				<!-- Carousel Image Wrapper -->
				<div class="relative w-full h-[300px] rounded-md overflow-hidden">
					<img src="{{asset('assets/frontend/images/dishes/chicken_karahi.jpg')}}" alt="Dish 1" class="w-full h-full object-cover rounded-md">
					<!-- Overlay on Hover -->
					<div class="absolute inset-0 bg-black/60 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300">
						<a href="#menu" class="btnStyle px-4 py-2 rounded-full">
							Order Now
			...
			<div class="max-w-[300px] lg:max-w-[400px] bg-frontend-dark-8 rounded-xl p-4 flex-shrink-0 group relative overflow-hidden">
				<!-- Carousel Image Wrapper -->
				<div class="relative w-full h-[300px] rounded-md overflow-hidden">
					<img src="{{asset('assets/frontend/images/dishes/chicken_plao.jpg')}}" alt="Dish 1" class="w-full h-full object-cover rounded-md">
					<!-- Overlay on Hover -->
					<div class="absolute inset-0 bg-black/60 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300">
						<a href="#menu" class="btnStyle px-4 py-2 rounded-full">
							Order Now
			...
			<div class="max-w-[300px] lg:max-w-[400px] bg-frontend-dark-8 rounded-xl p-4 flex-shrink-0 group relative overflow-hidden">
				<!-- Carousel Image Wrapper -->
				<div class="relative w-full h-[300px] rounded-md overflow-hidden">
					<img src="{{asset('assets/frontend/images/dishes/pizza.jpeg')}}" alt="Dish 1" class="w-full h-full object-cover rounded-md">
					<!-- Overlay on Hover -->
					<div class="absolute inset-0 bg-black/60 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300">
						<a href="#menu" class="btnStyle px-4 py-2 rounded-full">
							Order Now
			...
			<div class="max-w-[300px] lg:max-w-[400px] bg-frontend-dark-8 rounded-xl p-4 flex-shrink-0 group relative overflow-hidden">
				<!-- Carousel Image Wrapper -->
				<div class="relative w-full h-[300px] rounded-md overflow-hidden">
					<img src="{{asset('assets/frontend/images/dishes/Sichuan_Spicy_Noodles.jpg')}}" alt="Dish 1" class="w-full h-full object-cover rounded-md">
					<!-- Overlay on Hover -->
					<div class="absolute inset-0 bg-black/60 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300">
...
<section class="bg-frontend-dark-9 text-frontend-dark-2 px-6 py-10 mb-10 tracking-wider">
	<div class="flex justify-center">
	...
	<div class="max-w-[1200px] mx-auto grid md:grid-cols-3 gap-20 items-center">
		<div class="col-span-2">
			<img src="{{asset('assets/frontend/images/dishes/Sichuan_Spicy_Noodles.jpg')}}" alt="Oriental Dish" class="w-full h-auto max-h-[500px] rounded-xl shadow-lg object-fit">
		</div>
		<div>
			...
			<a href="#menu" class="inline-block btnStyle px-6 py-3 rounded-full">
				Order Now
			</a>
		</div>
...
<section class="bg-frontend-dark-9 text-frontend-dark-2 px-6 py-10 mb-10">
...
<section class="bg-frontend-dark-9 text-frontend-dark-2 px-6 py-10 mb-10">
	<div class="max-w-3xl mx-auto text-center">
		...
		<form action="" method="" class="flex flex-col sm:flex-row items-center justify-center gap-4">
			...
			<button type="submit" class="btnStyle px-6 py-3 rounded-full text-[17px] tracking-wider">
				Subscribe
			</button>
		</form>
	</div>
