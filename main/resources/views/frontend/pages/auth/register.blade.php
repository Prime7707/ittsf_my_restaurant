...
<main class="min-h-screen bg-frontend-dark-8 flex items-center justify-center px-4">
	<div class="w-full max-w-md bg-frontend-dark-9 p-8 rounded-2xl shadow-lg">
		<h2 class="text-3xl font-bold text-frontend-highlight-4 text-center mb-6">Create Your Account</h2>
		...
		<form method="POST" action="{{ route('register') }}" class="space-y-5">
			...
			<!-- Username -->
			<div>
				<label for="username" class="block text-sm font-medium text-frontend-dark-2 mb-1">Username</label>
				<input type="text" name="username" id="username" required class="w-full px-4 py-2 rounded-md bg-frontend-dark-7 text-white border border-frontend-dark-6 focus:outline-none focus:ring-2 focus:ring-frontend-highlight-4 focus:border-transparent transition" autofocus>
			</div>

			<!-- Email -->
			<div>
				<label for="email" class="block text-sm font-medium text-frontend-dark-2 mb-1">Email Address</label>
				<input type="email" name="email" id="email" required class="w-full px-4 py-2 rounded-md bg-frontend-dark-7 text-white border border-frontend-dark-6 focus:outline-none focus:ring-2 focus:ring-frontend-highlight-4 focus:border-transparent transition">
			</div>
		...
		<div class="mt-6 text-center text-sm text-gray-400">
			...
			<a href="{{ route('login') }}" class="text-frontend-highlight-4 hover:underline">Login here</a>
		</div>
	</div>
